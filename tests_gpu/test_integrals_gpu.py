#!/usr/bin/env python
"""
Polarization integrals are computed on the CPU and GPU and are compared.

To profile the GPU code use
 $ nvprof --metrics achieved_occupancy,branch_efficiency -fo log.nvprof python test_integrals_gpu.py
"""
import time
import numpy as np
